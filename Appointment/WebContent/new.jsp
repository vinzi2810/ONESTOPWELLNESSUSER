...
<script src="https://js.jotform.com/WidgetsServer.js?v=1553837186147" type="text/javascript"></script>
<script type="text/javascript">
   ...
   JotForm.prepareCalculationsOnTheFly([null,{"name":"selectAppointment","qid":"1","text":"Select Appointment Date","type":"control_head"},{"name":"selectSlot","qid":"2","text":"Select Slot","type":"control_button"},{"name":"typeA","qid":"3","text":"Date Reservation","type":"control_widget"},{"name":"typeA4","qid":"4","text":"Type a question","type":"control_widget"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,{"name":"selectAppointment","qid":"1","text":"Select Appointment Date","type":"control_head"},{"name":"selectSlot","qid":"2","text":"Select Slot","type":"control_button"},{"name":"typeA","qid":"3","text":"Date Reservation","type":"control_widget"},{"name":"typeA4","qid":"4","text":"Type a question","type":"control_widget"}]);}, 20); 
</script>
...
<form class="jotform-form" action="NewFile.jsp" method="post" name="form_90870876098473" id="90870876098473" accept-charset="utf-8">
            ...
            setTimeout(function()
{
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="90870876098473" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "90870876098473-90870876098473";
  </script>
